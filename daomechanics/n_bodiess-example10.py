...
for i in range(300):
    ...
    x2 = uniform(40, 150)
    m = uniform(500, 2000)
    g.add_body(Body(m, x1, x2, 20 * np.cos(np.pi * (v1 / 180)), 50 * np.cos(np.pi * (v1 / 180)), h=step))
...
for i in range(200):
    ...
    x2 = uniform(-100, -120)
    m = uniform(50, 2150)
    g.add_body(Body(m, x1, x2, 20* np.cos(np.pi * (v1 / 180)), 20* np.cos(np.pi * (v1 / 180)), h=step))
...
for i in range(300):
    ...
    x2 = uniform(200, 300)
    m = uniform(50, 2150)
    g.add_body(Body(m, x1, x2, 20* np.cos(np.pi * (v1 / 180)), 30 * np.cos(np.pi * (v1 / 180)), h=step))
...
anim.save('video/n-bodiess-3111.mp4', writer=writer)
