...
g.add_body(Body(5000, -1,-15 ,-0.00001*np.cos(np.pi / 4), -0.0001*np.cos(np.pi / 4),h=step))
g.add_body(Body(400, -6, -4,1*np.cos(np.pi / 4), -1*np.cos(np.pi / 4),h=step))

for i in range(20):
    x1 = uniform(0,3)
    x2 = uniform(0,50)
    m  = uniform(1000,2000)
    g.add_body(Body(9000, x1,x2 ,-0.00001*np.cos(np.pi / 4), -0.0001*np.cos(np.pi / 4),h=step))
...
for i in range(150):
    ...
    x2 = uniform(-0,100)
    m  = uniform(100,800)
    g.add_body(Body(100, x1,x2 ,1*np.cos(np.pi / 4), 1*np.cos(np.pi / 4),h=step))
    #g.add_body(Body(10000, x1+5,x2+6,1*np.cos(np.pi / 4), 1*np.cos(np.pi / 4),h=step))

g.add_body(Body(9000, -25,-30 ,-0.00001*np.cos(np.pi / 4), 0.0001*np.cos(np.pi / 4),h=step))
...
anim.save('video/s3s4nb.mp4', writer=writer)
